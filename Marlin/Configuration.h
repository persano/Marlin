...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_ENABLED_DEFAULT true  // Sensor enabled on boot; no need to run M412 S1
  #define NUM_RUNOUT_SENSORS   1
  #define FIL_RUNOUT_PIN       PA0         // Z-MIN connector (original Z endstop, repurposed)
  #define FIL_RUNOUT_STATE     LOW         // LOW = filament absent (NC sensor: pin pulled to GND when no filament)
