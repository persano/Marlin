...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN       PA0   // Z-MIN connector on mainboard (sensor must be rewired here from TFT)
  #define FIL_RUNOUT_STATE     HIGH  // HIGH = filament absent (switch open = pullup pulls HIGH; filament present = switch closes to GND = LOW)
